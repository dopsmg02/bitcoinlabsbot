...
// existing referral chain ΓÇö they don't exist in the DB yet.
...
export const authenticateTelegram = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        // 2. Parse User Data ΓÇö Safe JSON.parse with validation
        ...
        if (user) {
            // Existing user ΓÇö update login IP and premium status
